...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/bitsliver-cli.cpp \
           src/bitsliver-tx.cpp \
           src/bitsliver.cpp \
           src/db.cpp \
           ...
           src/qt/bitsliver.cpp \
           src/qt/bitsliverstrings.cpp \
...
RESOURCES += src/qt/bitsliver.qrc src/qt/bitsliver_locale.qrc

TRANSLATIONS += src/qt/locale/bitsliver_bg.ts \
                src/qt/locale/bitsliver_de.ts \
                src/qt/locale/bitsliver_en.ts \
                src/qt/locale/bitsliver_es.ts \
                src/qt/locale/bitsliver_fi.ts \
                src/qt/locale/bitsliver_fr.ts \
                src/qt/locale/bitsliver_it.ts \
                src/qt/locale/bitsliver_ja.ts \
                src/qt/locale/bitsliver_pl.ts \
                src/qt/locale/bitsliver_pt.ts \
                src/qt/locale/bitsliver_ru.ts \
                src/qt/locale/bitsliver_sk.ts \
                src/qt/locale/bitsliver_sv.ts \
                src/qt/locale/bitsliver_vi.ts \
                src/qt/locale/bitsliver_zh_CN.ts \
                src/qt/locale/bitsliver_zh_TW.ts
