...
This means one can have an always-on bitsliverd instance running, and another local bitsliverd/bitsliver-qt instance which connects to this node and receives blocks from it.
