...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BitSliver Core"),
     ...
     * override -datadir in the bitsliver.conf file in the default data directory
     * (to be consistent with bitsliverd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
