                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzBSVPathCustom = GetArg("-zbsvbackuppath", "");
    ...
    if(!strzBSVPathCustom.empty()) {
        ui->wallet_customzbsvbackuppath->setText(QString::fromStdString(strzBSVPathCustom));
        ui->wallet_customzbsvbackuppath_label->setVisible(true);
        ui->wallet_customzbsvbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzBSVPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the BitSliver RPC console.") + "<br>" +
