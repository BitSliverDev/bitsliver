                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BitSliver Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BitSliver address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitsliver: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zBSV"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BitSliver Core"), this);
    aboutAction->setStatusTip(tr("Show information about BitSliver Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BitSliver"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BitSliver addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BitSliver addresses"));
    ...
    openAction->setStatusTip(tr("Open a BitSliver: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BitSliver Core help message to get a list with possible BitSliver command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BitSliver Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BitSliver network", "", count));
}
...
{
    QString strTitle = tr("BitSliver Core"); // default title
