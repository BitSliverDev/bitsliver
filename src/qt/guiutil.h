...
/** Utility functions used by the BitSliver Qt UI.
 */
namespace GUIUtil
{
...
// Render BitSliver addresses in monospace font
...
// Parse "bitsliver:" URI into recipient object, return true on successful parsing
