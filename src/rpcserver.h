...
/**
 * BitSliver RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzbsvseed(const UniValue& params, bool fHelp);
extern UniValue getzbsvseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzbsv(const UniValue& params, bool fHelp);
extern UniValue dzbsvstate(const UniValue& params, bool fHelp);
