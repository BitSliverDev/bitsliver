...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BitSliver Core bitsliver-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitsliver-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitsliver transaction") + "\n" +
                               "  bitsliver-tx [options] -create [commands]   " + _("Create hex-encoded bitsliver transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitsliver transaction
