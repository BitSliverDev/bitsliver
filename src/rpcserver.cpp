...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop BitSliver server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "BitSliver server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BitSliver features */
        {"bitsliver", "masternode", &masternode, true, true, false},
        {"bitsliver", "listmasternodes", &listmasternodes, true, true, false},
        {"bitsliver", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitsliver", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bitsliver", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"bitsliver", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"bitsliver", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"bitsliver", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitsliver", "masternodedebug", &masternodedebug, true, true, false},
        {"bitsliver", "startmasternode", &startmasternode, true, true, false},
        {"bitsliver", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitsliver", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitsliver", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitsliver", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitsliver", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitsliver", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitsliver", "mnbudget", &mnbudget, true, true, false},
        {"bitsliver", "preparebudget", &preparebudget, true, true, false},
        {"bitsliver", "submitbudget", &submitbudget, true, true, false},
        {"bitsliver", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bitsliver", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bitsliver", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bitsliver", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bitsliver", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bitsliver", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bitsliver", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitsliver", "checkbudgets", &checkbudgets, true, true, false},
        {"bitsliver", "mnsync", &mnsync, true, true, false},
        {"bitsliver", "spork", &spork, true, true, false},
        {"bitsliver", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzbsvseed", &getzbsvseed, false, false, true},
        {"zerocoin", "setzbsvseed", &setzbsvseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzbsv", &searchdzbsv, false, false, true},
        {"zerocoin", "dzbsvstate", &dzbsvstate, false, false, true}
...
{
    return "> bitsliver-cli " + methodname + " " + args + "\n";
}
