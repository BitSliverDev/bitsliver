...
#   c) node1 mines 32 blocks, so now node 0 has 60001bsv, node 1 has 4250bsv, node2 has none.
#   d) node0 sends 601 bsv to node2, in two transactions (301 bsv, then 300 bsv).
