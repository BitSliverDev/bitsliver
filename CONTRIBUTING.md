Contributing to BitSliver Core
============================

The BitSliver Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BitSliver Core project, and is not to be
confused with overall BitSliver Network Protocol consensus changes.

Whether a pull request is merged into BitSliver Core rests with the project merge
...
Patches that change BitSliver consensus rules are considerably more involved than
...
Where a patch set proposes to change the BitSliver consensus, it must have been
...
The project leader is the release manager for each BitSliver Core release.
